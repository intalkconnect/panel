...
const AdminLayout = () => {
  ...
  return (
    <div className="min-h-screen flex bg-gray-50 dark:bg-gray-900 text-gray-900 dark:text-gray-100">
      {/* Botão de menu topo fixo */}
      <button
        className="fixed top-4 left-4 z-40 bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-700 rounded-lg p-2 shadow-md lg:hidden"
      ...
      {/* Conteúdo principal */}
      <main className="flex-1 min-h-screen p-6 pt-16 lg:pt-8 lg:pl-72 transition-all">
        <Outlet />
      </main>
